package kodilla.parametrized_tests.homework.com.kodilla.parametrized_tests;
...
public class GamblingMachine{
    public void howManyWins(Set<Integer> userNumbers) throws InvalidNumbersException {
